...
namespace MyEshopDemo.Areas.Admin.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Sender,Date,Email,Mobile,Content,IsRead")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Sender,Date,Email,Mobile,Content,IsRead")] Message message)
        {
            if (ModelState.IsValid)
            {
